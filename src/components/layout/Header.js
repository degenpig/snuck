...
const Header = () => {
    ...
    const [subclass, setSubClass] = useState("hidden")
    const showSubButtons = () => {
        console.log("click!")
        if (subclass === "hidden link") {
            setSubClass("show link");
        } else {
            setSubClass("hidden link");
        }
    }
        ...
        <>
            <div className="header">
                <div className="container">
                    {/* Mobile Snuck */}
                    <div className="-mr-2 flex justify-end snuck-mobile-section md:hidden">
                        <div className="w-full logo-section float-left">
                        </div>
                        <div className="snuck-btn-mobile-menu mt-2">
                            <button
                    ...
                    <div className="header-content">
                        ...
                        <div className="header-follow nav-bar"><a href="https://discord.gg/wZvGrbpHhj" target="_blank" rel="noreferrer"
                            className="social-link"><svg width="32" height="32" viewBox="0 0 72 72" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path
                                    ...
                                    fill="#000"></path>
                            </svg></a><a href="https://www.twitter.com/SnuckSol" target="_blank" rel="noreferrer"
                                className="social-link"><svg width="32" height="32" viewBox="0 0 72 72" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="36" cy="36" r="36" fill="white"></circle>
                                    <path
                                        d="M60.7441 21.5075C59.0252 22.2692 57.1785 22.7839 55.2372 23.0165C57.2403 21.8179 58.7389 19.9315 59.4534 17.7092C57.5714 18.8271 55.5117 19.6139 53.3638 20.0355C51.9194 18.4933 50.0062 17.4711 47.9214 17.1276C45.8365 16.7841 43.6965 17.1386 41.8337 18.1359C39.9709 19.1333 38.4895 20.7177 37.6194 22.6433C36.7494 24.5688 36.5394 26.7278 37.0221 28.7849C33.2088 28.5934 29.4784 27.6023 26.0729 25.8758C22.6675 24.1493 19.6631 21.726 17.2548 18.7633C16.4313 20.1838 15.9578 21.8307 15.9578 23.5847C15.9569 25.1637 16.3457 26.7185 17.0898 28.1112C17.8339 29.5038 18.9103 30.6913 20.2234 31.5682C18.7005 31.5198 17.2113 31.1083 15.8796 30.368V30.4915C15.8794 32.7061 16.6455 34.8526 18.0477 36.5667C19.45 38.2807 21.4021 39.4569 23.5728 39.8955C22.1601 40.2779 20.679 40.3342 19.2414 40.0602C19.8538 41.9658 21.0468 43.6321 22.6533 44.8259C24.2599 46.0197 26.1995 46.6813 28.2007 46.718C24.8036 49.3848 20.6081 50.8314 16.2892 50.825C15.5242 50.8252 14.7598 50.7805 14 50.6912C18.3839 53.5099 23.487 55.0058 28.6989 55C46.3417 55 55.9866 40.3875 55.9866 27.7144C55.9866 27.3026 55.9763 26.8868 55.9577 26.4751C57.8338 25.1183 59.4532 23.4383 60.74 21.5137L60.7441 21.5075V21.5075Z"
                                        fill="#000"></path>
                                </svg></a><a href="#" target="_blank" rel="noreferrer"
                                    className="social-link"><svg width="32" height="32" viewBox="0 0 72 72" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="36" cy="36" r="36" fill="white"></circle>
                                    ...
                                    rel="noreferrer" className="social-link"><svg width="32" height="32" viewBox="0 0 90 90" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                    <path
                                    ...
                                    rel="noreferrer" className="social-link"><svg version="1.2" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 80 48" width="48" height="32">
                                    <defs>
                                        <image width="81" height="48" id="img1"
                                    ...
                                    <style></style>
                                    <use href="#img1" x="-1" y="0"></use>
                                </svg></a></div>
                        <div className="d-flex flex-column right-btns">
                            <button className="justify-content-center wallet-adapter-button wallet-adapter-button-trigger" tabIndex="0"
                                type="button">Select Wallet</button>
                        </div>
                    </div>
                    <Transition
                        show={isOpen}
                            ...
                            <div className="md:hidden" id="mobile-menu">
                                <div ref={ref} className="px-2 pt-2 pb-3 space-y-1 sm:px-3 flex flex-col">
                                    <ul className="flex md:flex-row flex-col pl-5 gap-3 flex-wrap items-center text-[13px] w-full font-medium">
                                        ...
                                        <div className="d-flex flex-column right-btns">
                                            <button className="justify-content-center wallet-adapter-button mobile-wallet-adapter-button-trigger" tabIndex="0"
                                                type="button">Select Wallet</button>
                                        </div>
                                    </ul>
                                </div>
